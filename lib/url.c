                     ...
                     va_list param)
{
  ...
  case CURLOPT_HEADER:
    ...
    break;
  case CURLOPT_IGNORE_PROXY_HEADERS:
    /*
     * Set to ignore the headers generated by the proxy in the output.
     */
    data->set.ignore_proxy_headers = (0 != va_arg(param, long))?TRUE:FALSE;
    break;
